...
<<<<<<< HEAD
      <div className="sm:relative absolute z-30 bottom-20 flex flex-col gap-6 items-center justify-end mt-10 md:mb-20 md:w-1/2 p-5 md:p-12">
=======
...
>>>>>>> 2597299 (animation/ update logic)
         <Image
