...
export function TopSection({
  ...
  return (
    <div className="flex relative overflow-hidden h-svh w-full sm:w-[85%] flex-col sm:flex-row bg-white/80 sm:rounded-3xl sm:p-2">
      <LogoDriftBackground logoUrl={logoUrl || Logo} veilClassName="" className="sm:rounded-3xl" />
