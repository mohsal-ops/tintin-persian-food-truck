...
export default function ProductCardClient({
  ...
  return (
    <Link href={`/Menu`} className="group space-y-2 p-2 rounded-2xl transition-all duration-200 hover:-translate-y-1 hover:shadow-md">
      <Card
        className="flex  rounded-2xl overflow-hidden gap-5 sm:[h-72 w-72]  h-36 flex-col w-36  "
        key={id}
      >
...
export function PopularDishesCardClient({
  ...
  return (
    <div className="group space-y-2 p-2 rounded-2xl transition-all duration-200 max-w-40 hover:-translate-y-1 hover:shadow-md">
      <Card
